...
//Builtin Red led is Pin 2 on D1 R32 (17 on some esp32)
//Added Green led Pin 25, Pin 14 on some ESP32s Pin 12
#define LED_Stat 2 // this binks when packets are sent to panel
#define ledFeedback 14 //Blink a Led we can use to show ESP is running (Green Led)
...
//LCD Display Pins
#define SCREEN_SDA 5  //5, 4 for ESP board with built in screen
#define SCREEN_SCL 4  //18, 19 for my custom board
...
//#define ENABLE_DISPLAY //Comment out to disable using LCD (PUT BACK)
